...
select park.*, weather.*
from park
Join weather on weather.parkCode = park.parkCode where weather.parkCode = 'RMNP'

select * from park;

insert into survey_result values ('CVNP', 'tgavozzi@Kent.edu', 'OH', 'active')
insert into survey_result values ('CVNP', 'tgavozzi@Kent.edu', 'OH', 'active')
insert into survey_result values ('RMNP', 'tgavozzi@Kent.edu', 'OH', 'active')
insert into survey_result values ('RMNP', 'tgavozzi@Kent.edu', 'OH', 'active')
insert into survey_result values ('CVNP', 'tgavozzi@Kent.edu', 'OH', 'active')

select Count(survey_result.parkCode) as numberOfSurveys, park.parkName, park.parkCode
from survey_result
